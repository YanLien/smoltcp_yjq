...
//     pub fn init(max_fdb_entries: u16, now: Instant) -> Arc<Mutex<Self>> {
//         let fdb: BTreeMap<EthernetAddress, BridgeDfdbEntry> = (0..max_fdb_entries)
...
//                 dfdb_clone.lock().unwrap().age_one_second(now);
//             }
//         });
